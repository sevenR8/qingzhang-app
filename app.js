  ...
  app.innerHTML = `
    <main class="auth-screen">
      <div class="auth-shell">
        <div class="brand"><span class="brand-mark">青</span> 青帳</div>
